export function SkeletonCard() {
  return (
    <div className="p-5 bg-slate-900/85 backdrop-blur-2xl rounded-2xl border border-white/10 animate-pulse shadow-2xl shadow-black/40">
...
export function SkeletonSpinner() {
  return (
    <div className="flex flex-col items-center justify-center py-16 gap-4">
      ...
      <p className="text-sm text-white/60">Procesando...</p>
    </div>
  );
}
